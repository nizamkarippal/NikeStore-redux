    ...
    ease-in-out w-full hover:scale-105`}>
        ...
        `}>
            ...
            my-2">
                ...
                px-1 rounded blur-effect-theme"><h1 className="text-black
                text-sm font-medium">${price}</h1></div>
                <div className="flex items-center gap-1"><StarIcon className="icon-style 
            ...
            <div className="flex items-center gap-3">
              ...
              <button type="button"  onClick={()=>{onAddToCart(); onCartToggle();}} className="bg-white/90
              blur-effect-theme button-theme px-2 py-1 shadow shadow-sky-200
              text-sm text-black">{btn}</button>
            </div>

        </div>
        <div className={`flex items-center
        ${ifExists? "absolute top-5 right-1":
         "justify-center"}`}>
