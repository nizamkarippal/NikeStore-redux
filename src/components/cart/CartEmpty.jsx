...
const CartEmpty = ({onCartToggle}) => {
  return (
    ...
    px-11 text-center gap-7`}>
        ...
        button-theme bg-gradient-to-b from-amber-500 to-orange-500
        shadow-lg shadow-orange-500 flex items-center
        justify-center text-slate-900 py-2 gap-3 text-sm px-5
        font-semibold`}>
            <ArrowLeftIcon className="w-5 h-5 text-slate-900" />
            <span className="">Back To Nike</span>
        </button>
    </div>
    </>
  )
