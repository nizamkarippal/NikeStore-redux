...
export const {setCloseCart,setOpenCart,
    setAddItemToCart,setRemoveItemToCart,setIncreaseItemQTY,
setDecreaseItemQTY,setClearCartItem,setGetTotals} = CartSlice.actions;
